...
const Skills = () => {
  ...
  const frontendSkills = [
    ...
    { name: 'JavaScript', img: 'https://skillicons.dev/icons?i=js', expertise: 'Expert', level: 92 },
    { name: 'React.js', img: 'https://skillicons.dev/icons?i=react', expertise: 'Expert', level: 93 },
    { name: 'Next.js', img: 'https://skillicons.dev/icons?i=nextjs', expertise: 'Expert', level: 95 },
    { name: 'TypeScript', img: 'https://skillicons.dev/icons?i=ts', expertise: 'Expert', level: 88 },
  ];

  const backendSkills = [
    { name: 'Node.js', img: 'https://skillicons.dev/icons?i=nodejs', expertise: 'Expert', level: 90 },
    { name: 'Express.js', img: 'https://skillicons.dev/icons?i=express', expertise: 'Expert', level: 88 },
    { name: 'MongoDB', img: 'https://skillicons.dev/icons?i=mongodb', expertise: 'Expert', level: 88 },
    { name: 'Firebase', img: 'https://skillicons.dev/icons?i=firebase', expertise: 'Expert', level: 88 },
    // { name: 'Docker', img: 'https://skillicons.dev/icons?i=docker', expertise: 'Intermediate', level: 80 },
    { name: 'PostgreSQL', img: 'https://skillicons.dev/icons?i=postgres', expertise: 'Expert', level: 87 },
    { name: 'SQL', img: 'https://skillicons.dev/icons?i=sql', expertise: 'Intermediate', level: 75 },
    { name: 'ORACLE', img: 'https://skillicons.dev/icons?i=oracle', expertise: 'Intermediate', level: 75 },
  ...
  const toolsSkills = [
    ...
    { name: 'GitHub', img: 'https://skillicons.dev/icons?i=github', expertise: 'Expert', level: 93 },
    { name: 'VS Code', img: 'https://skillicons.dev/icons?i=vscode', expertise: 'Expert', level: 92 },
    // { name: 'Postman', img: 'https://skillicons.dev/icons?i=postman', expertise: 'Intermediate', level: 80 },
    { name: 'Figma', img: 'https://skillicons.dev/icons?i=figma', expertise: 'Intermediate', level: 75 },
